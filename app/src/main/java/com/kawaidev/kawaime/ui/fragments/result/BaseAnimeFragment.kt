...
abstract class BaseAnimeFragment : Fragment() {
    ...
    @State protected var isLoading = false
    @State protected var isEmpty = false
    @State protected var hasNextPage = false
    @State protected var error: Exception? = null
    @State protected var isAppBarHidden: Boolean = false
    @State protected var anime: List<BasicRelease> = emptyList()
    @State protected var page: Int = 1
    @State protected var isFetched: Boolean = false
